...
<body>
	...
	$sqlcategories = "SELECT category_id FROM categories;";
	$res_categories = mysqli_query($conexion, $sqlcategories);

	$sqlbusiness = "SELECT business_id FROM businesses;";
	...
	<form ACTION="11-bd-empleo-operaciones-tabla-bizcategories.php"
		METHOD=POST>
