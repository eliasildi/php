...
?>
	<FORM ACTION="ej50-calculo_promedio_notas_ciclo_asirELIAS.php" METHOD=POST>
		<table border="1">
			<tr>
				<td>Nombre del Alumno</td><td colspan="2"><INPUT NAME="alumno" size="50" MAXLENGTH="50" TYPE="TEXT" VALUE="<?php if (isset($nombre)) echo $nombre; else echo ""; ?>" /><br />
				</td>
			</tr>
			<tr>
