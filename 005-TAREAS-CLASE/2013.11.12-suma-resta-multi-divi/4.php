...
$error="No se puede dividir entre 0";
	...
	if (isset($_POST['divi']) ) {	if ($operador2==0)	{
										$resultado=$error;
														}
									else 	{
	...
	<FORM ACTION="4.php" METHOD=POST>
		<table align='center' border="1">
			...
			<tr align='center'>
				...
				<td><INPUT size="23" NAME="resultado" TYPE="TEXT" VALUE="<?php if (isset($resultado)) echo $resultado; else echo ''; ?>" disabled="disabled" /><br /></td>
			</tr>
		</table>
		<table align='center' >
			<tr>
			<td><INPUT NAME="suma" TYPE="SUBMIT" VALUE="SUMAR"></td> <td><INPUT NAME="resta" TYPE="SUBMIT" VALUE="RESTAR"></td>
			<td><INPUT NAME="multi" TYPE="SUBMIT" VALUE="MULTIPLICAR"></td> <td><INPUT NAME="divi" TYPE="SUBMIT" VALUE="DIVIDIR"></td>
			</tr>
		</table>
	</FORM>
</body>
