	...
	if ( isset($_POST["enviado"]) )  {
		...
		if ( strlen( $nifalm ) == 9 ) {
			if ( ($nifalm[0] == 'X') OR ($nifalm[0] == 'Y') OR ($nifalm[0] == 'Z') ) {
				switch ($nifalm[0]) {
					case "X":
						$numero = (int)substr($nifalm, 1, 7); //posicion 1 y 7 caracteres
						break;
					case "Y":
...
Introduzca el NIE: <INPUT NAME="nie" size="9" MAXLENGTH="9" TYPE="TEXT" VALUE="" /><br />
				   <input type="hidden" name="enviado" value="1" /><br />
