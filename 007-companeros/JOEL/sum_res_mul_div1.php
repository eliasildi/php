...
<FORM ACTION="sum_res_mul_div1.php" METHOD=POST>
<table style="border:1px solid black; border-collapse:collapse; text-align:center;" align="center">
		...
		<tr>
			<td><INPUT size="3" NAME="n1" TYPE="TEXT" VALUE="<?php if (isset($sumar)) { echo $n1; } else { echo ""; }?>"></td>
			<td><INPUT size="3" NAME="n2" TYPE="TEXT" VALUE="<?php if (isset($sumar)) { echo $n2; } else { echo ""; }?>"></td>
			<td><INPUT size="3" NAME="" TYPE="TEXT" VALUE="<?php if (isset($sumar)) { echo $resultado; } else { echo ""; }?>" disabled="disabled"></td>
		</tr>
