...
<body>
	...
	if (isset($_GET['tiposareas'])) {
		...
		$tiposareas = $_GET['tiposareas']; // LE ASIGNO EL ARRAY QUE ME DA LAS RESPUESTAS
	...
	if (isset($_GET['intereses'])) {
		$inputs = array();  // crea un array vacio
		$inputs = $_GET['intereses'];  // a ese array vacio se le asigna los valores que recogemos
