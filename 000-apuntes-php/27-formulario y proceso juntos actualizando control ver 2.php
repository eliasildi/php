...
<FORM ACTION="27-formulario y proceso juntos actualizando control ver 2.php" METHOD=POST>
	<table align="center" border="0">
		<tr>
			<td align="left" width="100">Nombre:</td>
			<td align="center" width="150"><INPUT NAME="nombre" MAXLENGTH="25"
				TYPE="TEXT"
				VALUE="<?php if (isset($form_nombre)) echo $form_nombre; else echo "Inserte un nombre..."; ?>">
			</td>
		</tr>
		<tr>
			...
			<td align="center" width="150"><INPUT NAME="mail" MAXLENGTH="25"
				TYPE="TEXT"
				VALUE="<?php if (isset($form_mail)) echo $form_mail; else echo "Inserte un e-mail..."; ?>">
			</td>
		</tr>
		<tr>
			...
			<td align="center" width="150"><INPUT NAME="motivo" MAXLENGTH="25"
				TYPE="TEXT"
				VALUE="<?php if (isset($form_motivo)) echo $form_motivo; else echo "Inserte un motivo..."; ?>">
			</td>
		</tr>
		<tr>
			<td align="left" width="100">Mensaje:</td>
			<td><TEXTAREA NAME="mensaje" ROWS=3 COLS=20>
					<?php if (isset($form_mensaje)) echo $form_mensaje; else echo "Inserte un mensaje..."; ?>
				</TEXTAREA>
			</td>
		</tr>
		<tr>
			<td widht="100"><INPUT NAME="boton" TYPE="SUBMIT" VALUE="Enviar"></td>
			<td align="right" width="100"><INPUT NAME="borrar" TYPE="RESET"	VALUE="Limpiar"></td>
		</tr>
	</TABLE>
